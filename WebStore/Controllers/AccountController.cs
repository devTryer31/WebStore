...
namespace WebStore.Controllers
{
	public class AccountController : Controller
	{
		...
		public async Task<IActionResult> Register(LoginOrRegisterViewModel model)
		{
			...
			if (registerModel.Name == null || registerModel.Password == null || registerModel.SamePassword == null ||
			    loginModel.Name != null || loginModel.Password != null)//need js lock second form while filling.
